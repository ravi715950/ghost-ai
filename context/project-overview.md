...
- Enterprise permission tier beyond owner and collaborator
- Version spec history and review workflows
...
2. Multiple users can collabrate in the same canvas simultaneously.
3. A user can import a prebuilt stater design into the canvas.
