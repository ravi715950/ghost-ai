...
Build this project increamentlly using a spec-driven workflow. Context 
files define what to build. how to build it and what the current state
of progress is. Always implement against these specs - do not infer or invent behavior from scratch.
