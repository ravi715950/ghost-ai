...
- Use CSS custom property tokens define in `globals.css` - no raw tailwind color classes like `zinc-*` or hardcoded hax values.
- Referance tokens through their Tailwind utility names: `bg-base`, `text-copy-primary`, `border-surface-border`, `text-brand`, etc.
